...
import { Pool } from "pg";
import { ensureDbReady, getPglite, vercelWithoutDatabase } from "../db";
...
// Skip on Vercel/Lambda — PGLite's wasm image is not on that filesystem.
...
// the app turns sign-in on. On Vercel without DATABASE_URL, omit the dialect so
// Better Auth never constructs PGlite (`ENOENT /var/task/_libs/pglite.data`).
