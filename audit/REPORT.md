...
| R11 | High | Chunk replacement deletes then inserts without a transactional staging/swap boundary. A failed ingest can erase working evidence. | **Open:** immutable source revisions, staged chunks/embeddings, transactional active-version pointer, rollback and resumable jobs. |
